...
from dataset import read_manifest,centered_crop,CLASSES,MEAN,STD
...
def main():
    torch.set_num_threads(2);d=prepare();out=ROOT/'cnn_results';out.mkdir(exist_ok=True)
    ...
    for recipe,tau,balanced in [('ce',0,False),('la',1,False),('balanced_ce',0,True)]:
