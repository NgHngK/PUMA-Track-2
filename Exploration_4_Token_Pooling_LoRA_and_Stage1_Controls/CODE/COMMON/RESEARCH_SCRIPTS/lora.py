"""Restricted UNI2 Q/V LoRA using immutable cached blocks0–19 outputs."""
...
class Adapted(nn.Module):
 def __init__(self,seed,representation='A3'):
  ...
  enc=load_uni2('D:/Research/PUMA/Code/PUMA_pretrained_checkpoints/UNI2-h/uni2_h_model.bin').eval().requires_grad_(False);self.blocks=nn.ModuleList(list(enc.blocks[20:]));self.norm=enc.norm;del enc;gc.collect()
