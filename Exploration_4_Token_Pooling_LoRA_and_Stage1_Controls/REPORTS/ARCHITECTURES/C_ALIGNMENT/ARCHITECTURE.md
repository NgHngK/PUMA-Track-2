# Detector-held paired coordinate control

Exploration4 architecture ID: `C_ALIGNMENT`. **27,866 trainable parameters** for the executed configuration. Both Stage2 partitions restricted to historical detector fold0; matched nuclei only. No full-proposal score. Failed promotion.

## Mathematical and tensor contract

`h = A3(RGB, GT center or Stage1 center)`
...
flowchart TD
 ...
 T --> H[Detector-held paired coordinate control]
