# Duplicate FOV96 capacity control

Exploration4 architecture ID: `B_duplicate`. **40,234 trainable parameters** for the executed configuration. Same additional capacity with no new scale; one shared control avoids redundant reruns.

## Mathematical and tensor contract

`z = z_A5(CLS96,b) + V96 P96 LN(CLS96)`
...
flowchart TD
 ...
 T --> H[Duplicate FOV96 capacity control]
