# CLS and Gaussian mean

Exploration4 architecture ID: `A4`. **27,866 trainable parameters** for the executed configuration. Equal normalized mean without new trainable pooling parameters.

## Mathematical and tensor contract

`h = LN((LN(T[0]) + LN(Σ_j w_j T[9+j]))/2)`
