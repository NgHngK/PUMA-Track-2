# Clean-cohort A3 reference

Exploration4 architecture ID: `F_A3`. **27,866 trainable parameters** for the executed configuration. Same80/76 clean mask cohort; this score is not comparable to original300/150 confirmation.

## Mathematical and tensor contract

`h = LN(mean target3×3 tokens)`
