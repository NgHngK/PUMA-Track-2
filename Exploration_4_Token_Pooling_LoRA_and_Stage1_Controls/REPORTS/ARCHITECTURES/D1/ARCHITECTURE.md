# ROI-class sampling control

Exploration4 architecture ID: `D1`. **27,866 trainable parameters** for the executed configuration. Uniform nonempty ROI-class bucket followed by uniform nucleus; ordinary CE. Failed promotion.

## Mathematical and tensor contract

`q(i)=1/(K n_{ROI(i),class(i)})`
...
flowchart TD
 ...
 T --> H[ROI-class sampling control]
