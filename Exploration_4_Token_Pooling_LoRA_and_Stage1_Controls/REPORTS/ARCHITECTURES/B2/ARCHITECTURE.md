# Additional FOV128 context

Exploration4 architecture ID: `B2`. **40,234 trainable parameters** for the executed configuration. Identical extra capacity to B1; failed promotion.

## Mathematical and tensor contract

`z = z_A5(CLS96,b) + V128 P128 LN(CLS128)`
