# Single retained full-scale architecture

Exploration4 architecture ID: `FINAL_RECOMMENDED_A5`. **27,866 trainable parameters** for the executed configuration. Frozen CLS1536; h=nonaffine LN(CLS); b=training-standardized TierA16. Retained after A3 confirmation failure.
...
flowchart TD
 ...
 T --> H[Single retained full-scale architecture]
