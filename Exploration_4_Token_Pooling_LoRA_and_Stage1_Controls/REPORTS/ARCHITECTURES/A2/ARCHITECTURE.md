# Gaussian target pooling

Exploration4 architecture ID: `A2`. **27,866 trainable parameters** for the executed configuration. Fixed Gaussian width9 source pixels; no learned attention.

## Mathematical and tensor contract

`w_j = exp(-||g_j-p||²/(2·1.5²)) / Σ_k exp(-||g_k-p||²/(2·1.5²)); h = LN(Σ_j w_j T[9+j])`
