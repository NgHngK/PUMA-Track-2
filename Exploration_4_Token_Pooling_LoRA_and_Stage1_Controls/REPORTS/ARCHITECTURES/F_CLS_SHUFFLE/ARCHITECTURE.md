# CLS and shuffled mask control

Exploration4 architecture ID: `F_CLS_SHUFFLE`. **27,866 trainable parameters** for the executed configuration. Matched control for CLS-plus-mask pooling.

## Mathematical and tensor contract

`h = LN((LN(CLS)+LN(shuffled-mask tokens))/2)`
...
flowchart TD
 ...
 T --> H[CLS and shuffled mask control]
