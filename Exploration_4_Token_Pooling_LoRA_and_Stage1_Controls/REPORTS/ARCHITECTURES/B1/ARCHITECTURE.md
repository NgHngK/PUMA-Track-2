# Additional FOV64 context

Exploration4 architecture ID: `B1`. **40,234 trainable parameters** for the executed configuration. P64 is1536→8; V64 is8→10 and initially zero. Failed promotion.

## Mathematical and tensor contract

`z = z_A5(CLS96,b) + V64 P64 LN(CLS64)`
