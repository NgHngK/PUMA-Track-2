# Clean-cohort geometric reference

Exploration4 architecture ID: `F_GAUSSIAN`. **27,866 trainable parameters** for the executed configuration. Fixed sigma1.5 patch units; same cohort as mask controls.

## Mathematical and tensor contract

`h = LN(Σ_j w_Gaussian,j T[9+j])`
...
flowchart TD
 ...
 T --> H[Clean-cohort geometric reference]
