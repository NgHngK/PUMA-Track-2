# Target-containing patch

Exploration4 architecture ID: `A1`. **27,866 trainable parameters** for the executed configuration. One final normalized patch token at the transformed coordinate.

## Mathematical and tensor contract

`h = LN(T[9 + 16 floor(v) + floor(u)])`
