# Five-epoch matched frozen control

Exploration4 architecture ID: `E0_FROZEN`. **27,866 trainable parameters** for the executed configuration. Same original300/150, seeds and five-epoch endpoint as restricted LoRA.
...
flowchart TD
 ...
 T --> H[Five-epoch matched frozen control]
