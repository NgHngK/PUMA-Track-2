# Frozen CLS reference

Exploration4 architecture ID: `A0`. **27,866 trainable parameters** for the executed configuration. The exact Exploration3 A5 head and representation; nine saved-logit comparisons have maximum error0.
