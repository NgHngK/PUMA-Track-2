# Exploration3 / Full TierB diagnostic
...
Test full compactmaskfeatures; contaminated upstream.

## Exact forward

`z=Wh+a+V b_B`. CLS1536 plus20mask features→10zero-init. Here h is nonaffine-LN1536, b is the selected feature vector standardized using only current training rows.

## Parameter count

15,570 trainable head parameters. Encoder frozen; no LoRA. Models and per-run measured counts are in RUNS/<ID>/summary.json.
